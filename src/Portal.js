...
import { Scene, WebGLRenderTarget, TextureLoader, EquirectangularReflectionMapping, AlwaysStencilFunc, ReplaceStencilOp, DoubleSide, LinearEncoding } from 'three'
import { GLTFLoader } from 'three/examples/jsm/loaders/GLTFLoader'
import FillQuad from './FillQuad'

const scene = new Scene()
scene.background = new TextureLoader().load(process.env.PUBLIC_URL + '/textures/galaxy.jpg', (texture) => {
